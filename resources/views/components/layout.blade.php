...
<body class="h-full bg-gray-800">
  <div class="min-h-full">
          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                <x-navLink href="/posts" :active="request()->is('posts')" type='a'>Posts</x-navLink>
            ...
            <div class="ml-4 flex items-center md:ml-6">
              ...
              <div class="relative ml-3" x-data="{ open: false }">
                ...
                <div x-show="open"
                  ...
                  <a href="/about" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-1">Settings</a>
                  <a href="/contact" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-2">Sign out</a>
                </div>
              </div>
            </div>
          </div>
    ...
    <main>
      {{ $heading }}
      <div class="mx-auto bg-gray-800 text-white   sm:px-0 lg:px-0 flex flex-col items-center justify-center">
